...
python .\src\ml_utils\train_test_prototype.py --workers 6 --img_size 1024 --segments 300 --epochs 200 --data_mode lazy  --checkpoint_dir checkpoints_long_run_v5
...
python .\src\ml_utils\eval.py  --segments 300 --data_mode lazy --workers 2  --checkpoints_dir checkpoints_long_run_v5

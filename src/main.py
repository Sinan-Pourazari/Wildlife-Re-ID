...
def main():
    ...
    video_path = r"C:\Users\sinan\Projects\Wildlife-Re-ID\src\test_vid\nestler_bg.mp4"
    animal_video_path = r"C:\Users\sinan\Projects\Wildlife-Re-ID\src\test_vid\whole.mp4"
    #animal_video_path = r"C:\Users\sinan\Projects\Wildlife-Re-ID\src\test_vid\Foxes\concat.mp4"
    animal_video_path= r"C:\Users\sinan\Projects\Wildlife-Re-ID\src\test_vid\Foxes\Fox_Nestler_BG (2).MOV"
    bg_sub = BackgroundSubtracktor(video_path,10 ,50, alpha= 0.05, running_start=True)
